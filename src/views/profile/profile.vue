  ...
  >
    <v-card style="width: 70%; margin: auto; background-color: #edecec">
      ...
      >
        ...
        <!-- 프로필 및 여러 버튼 부분 -->
        <v-row class="mt-10 justify-center mr-10">
          <v-btn
...
export default {
  ...
  methods: {
    ...
    goGptBoard() {
      this.$router.push('/gpt/board');
    },
    homeProfile() {
      this.$router.push('/profile/' + this.userId);
    },
    profileEdit(profile) {
      this.$router.push('/profile/edit/' + profile.username);
    },
    boardcreate(profile) {
      this.$router.push('/board/create/' + profile.numberid);
    },
  },
};
</script>
