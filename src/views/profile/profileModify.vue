...
export default {
  ...
  mounted() {
    this.$axios
      .get('/profile/edit/' + this.$route.params.id)
      .then((response) => {
        this.profile = response.data;
        // profile.technologies를 chips에 복사
        this.chips = this.profile.technologies.map((tech) => tech.content);
